...
@rem Add default JVM options here. You can also use JAVA_OPTS and CONFÝG_SERVER_OPTS to pass JVM options to this script.
...
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CONFÝG_SERVER_OPTS%  -classpath "%CLASSPATH%" demo.ConfigServerApp %CMD_LINE_ARGS%
...
:fail
rem Set variable CONFÝG_SERVER_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%CONFÝG_SERVER_EXIT_CONSOLE%" exit 1
exit /b 1
